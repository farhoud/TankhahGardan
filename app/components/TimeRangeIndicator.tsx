...
export const TimeRangeIndicator = observer(function TimeRangeIndicator(
  ...
  const animatedWidth = useDerivedValue(() => {
    return withTiming(interpolate(indicatorWidth.value, [0, 1440], [0, width.value]), { duration: 1000 })
  })
  ...
  return (
    <View
      ...
      style={$styles}
    >
      <Animated.Text style={$timeTextStyle}>asd</Animated.Text>
      <Animated.View style={$timeRangeStyle}/>
      <Animated.Text style={$timeTextEndStyle}>asd</Animated.Text>
    </View>
  )
})
